    ...
    public partial class AddClientEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddonCategories", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MessageKey = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OperatingStatus = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addons_AddonCategories_AddonCategoryId",
                        column: x => x.AddonCategoryId,
                        principalTable: "AddonCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                name: "MenuItemAddonCategories",
                columns: table => new
                {
                    AddonCategoriesId = table.Column<int>(type: "int", nullable: false),
                    MenuItemsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemAddonCategories", x => new { x.AddonCategoriesId, x.MenuItemsId });
                    table.ForeignKey(
                        name: "FK_MenuItemAddonCategories_AddonCategories_AddonCategoriesId",
                        column: x => x.AddonCategoriesId,
                        principalTable: "AddonCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuItemAddonCategories_MenuItems_MenuItemsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethod = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DeliveryType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemAddons", x => new { x.AddonsId, x.OrderItemsId });
                    table.ForeignKey(
                        name: "FK_OrderItemAddons_Addons_AddonsId",
                        column: x => x.AddonsId,
                        principalTable: "Addons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemAddons_OrderItems_OrderItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AddonCategories_Name",
                table: "AddonCategories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Addons_AddonCategoryId",
                table: "Addons",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BotMessages_MessageKey",
                table: "BotMessages",
                column: "MessageKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemAddonCategories_MenuItemsId",
                table: "MenuItemAddonCategories",
                column: "MenuItemsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemAddons_OrderItemsId",
